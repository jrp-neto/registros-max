...
Download da última versão: [Registros Max v.1.3.3](https://github.com/jrp-neto/registros-max/releases/download/v.1.3.3/Registros.Max.v.1.3.3.rar)

Download Excel: [Registros CRA](https://github.com/jrp-neto/registros-max/releases/download/base/Registros.CRA.xlsx)

## 📦 Instalação

1. Baixe o arquivo Registros.Max.v.1.3.3.rar
